...
language: "Español"
spoiler:
  "Un libro sobre diseño de software con un enfoque práctico y alejado de
  dogmatismos"
...
Durante las últimas semanas he estado leyendo este maravilloso libro escrito por
...
Robert C. Martin (y mucha de la literatura que hay por ahí fuera) pone el foco
especialmente en **reglas** y **principios**: tamaño de las entidades
...
en _A Philosophy of Software Design_ nos encontramos un par de capítulos
...
De todos, el capítulo 10: _Define Errors Out Of Existence_, me ha parecido una
delicia, y creo que introduce conceptos muy interesantes para lidiar con los
casos esquina y errores de cualquier aplicación.

Del mismo modo, algunos pasajes hablando sobre la ventaja de definir
abstracciones “profundas” (_deep_) en lugar de “planas” (_shallow_) ilustran
bastante bien los problemas de llevar técnicas de _Clean Code_ al extremo, sin
aplicar un buen criterio.

Creo que la lectura de este libro me ha servido para adoptar un enfoque más
