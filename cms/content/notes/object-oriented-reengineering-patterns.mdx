...
[Este libro](https://www.amazon.es/Object-Oriented-Reengineering-Patterns-Engineering-Programming/dp/1558606394)
...
evolucionarlo y mantenerlo.

Los últimos capítulos están dedicados a estrategias de diseño de software que
...
Un libro muy interesante si te toca unirte a un proyecto ya en marcha o te
...
cubren en profundidad en la parte II: _Reverse Engineering_).

> A culture of continuous reengineering is a prerequisite for achieving ﬂexible
> and maintainable object-oriented systems.

- «_It is easy to get seduced by focussing on the technical problems that
  interest you the most, rather than what is best for the project._»
- «_Other engineering disciplines rely on the laws of nature to hide irrelevant
  ...
  cannot possible investigate everything._»
- «_Documentation is almost always out of date with respect to the actual
  ...
  Read all the Code in One Hour and Interview During Demo)_»
- «_As a rule of the thumb, assume that a single team can reengineer as much
  code as they can write from scratch._»
- «_If you fail to deliver good initial results, you will learn a lot, but you
  ...
  initial tasks._»
- «_Nevertheless, even outdated information may be useful, because at least it
  tells you how the system was supposed to behave in the past. This is a good
  starting point to infer how it is used today._»
