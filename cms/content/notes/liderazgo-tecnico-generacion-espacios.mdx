...
Reflexionando sobre mi trabajo los últimos años, donde he tenido que cumplir con
...
**lo más valioso que he conseguido ha sido facilitar espacios de reflexión,
discusión y aprendizaje continuo**.

¿A qué me refiero cuando hablo de espacios? Realmente, a nada físico o temporal,
...
se vive con prisa, ¿verdad? 🙂

Mis iniciativas en este ámbito han orbitado siempre en torno a los siguientes 3
puntos:

- **Utilizar cada tarea (story, feature) como una oportunidad única para
  aprender**: como desarrollador, no hay curso o taller que me haya enseñado más
  ...
  en el día a día.
- **Utilizar cada code review como un espacio de discusión**: este espacio viene
  casi _de gratis_, ya que no son pocos los equipos que tienen integrado en su
  ...
  arrancar la discusión con la merge request ya cerrada!).
- **Crear eventos recurrentes PARA el equipo**: y aquí hablo únicamente de mi
  ...
  semana -¡en [PrivacyCloud](https://privacycloud.com/) lleva funcionando desde
  ...
  charla juntas, practicar una kata...

## Y de manera tangencial...

- En mi experiencia, invertir tiempo en **tener ciclos de feedback (muy) cortos
  fomenta sin lugar a dudas espacios de experimentación dentro del equipo**. A
  ...
  abrazaré el cambio con mayor seguridad, ya que podré ir revisándolo cada poco.
- Las pull requests son un compromiso en el camino por alcanzar un trabajo 100%
